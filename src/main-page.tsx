    ...
    <div className="card">
      <div className="space-wrap">
        ...
        <div className="name-title">
          ...
          >
            <h1 className="full-name jittery-text">Chris Arnesen</h1>
            <h3 className="current-title jittery-text">Web Engineer</h3>
          </a>
        </div>
      </div>
      <div className="social-links">
        ...
        <a href="https://carnesen.yelp.com">
          <img src="/images/yelp.svg" alt="icon for yelp" />
        </a>
      </div>
    </div>
  </div>
